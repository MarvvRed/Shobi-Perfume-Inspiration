...
(function(){
  ...
  function applyTerre97(card){
    if(!/Best Seller #97\b/.test(card.textContent||'')) return false;
    ...
    link.href='https://www.fragrantica.com/perfume/Hermes/Terre-d-Hermes-17.html';
    link.target='_blank'; link.rel='noopener noreferrer';
    link.title='View on Fragrantica'; link.setAttribute('aria-label','View Terre d\'Hermes on Fragrantica');
