...
(function () {
    ...
    async function loadOfficialCatcherForFirst20() {
        ...
        try {
            ...
            // Preserve any #21+ catcher records generated by Deploy Pages and only refresh #1-#20.
            window.SHOBI_CATCHER_NOTES_BY_CODE = {
                ...(window.SHOBI_CATCHER_NOTES_BY_CODE || {}),
                ...byCode
            };
            window.SHOBI_CATCHER_CARD_AUDIT = {
                ...
                missing,
                totalAvailable: Object.keys(window.SHOBI_CATCHER_NOTES_BY_CODE || {}).length
            };
            console.log(`Official Catcher card bridge #1-#20: ${Object.keys(byCode).length}/20 loaded; ${Object.keys(window.SHOBI_CATCHER_NOTES_BY_CODE || {}).length} total catcher codes available.`);
